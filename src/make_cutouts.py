...
fits_file = '/mnt/c/users/Coque/Downloads/mosaic_plckg165_nircam_f200w_30mas_20230403_drz.fits'  # Replace with the actual FITS file path for LINUX
...
output_dir = os.path.expanduser("~/G165/original_small_cutouts")
...
positions = {
    "cutout_f200": (1 * coordinates[1] // 4, 3* coordinates[0] // 4),  # upper left
}
